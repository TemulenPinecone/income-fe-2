...
export default function Home() {
  ...
  return (
    <div>
      ...
      {/* CARDS */}
      <div className="w-[30%] h-[130px] mb-10 mt-5 flex flex-col justify-around">
        <img
        ...
        />
        <div className="flex items-center gap-2 relative pl-5">
          <Icon1 />
          <p className="text-[25px] text-white">Geld</p>
        </div>
        <div className="relative pl-5 flex justify-between">
          <div>
            <p className="font-extralight">Cash</p>
      ...
      <div className="flex gap-2">
        {/* BAR CHART */}
        <div className="w-[50%] bg-gray-200 rounded-xl px-5 py-3">
